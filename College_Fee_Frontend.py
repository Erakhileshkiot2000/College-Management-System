...
class college_fee():
    def __init__(self, master):
        ...
        College_Main_Frame = Frame(self.master, bg='green')
        College_Main_Frame.grid()

        College_Title_Frame = LabelFrame(
            College_Main_Frame, width=1350, height=100, bg='green', relief='ridge', bd=15)
        ...
        College_Data_Frame = Frame(College_Main_Frame, width=1350, height=350,
                                   bg='green', relief='ridge', bd=15)
        College_Data_Frame.pack(side=TOP, padx=15)

        College_Frame_1 = LabelFrame(College_Data_Frame, width=850, height=350, bg='green', relief='ridge', bd=8,
                                     text='Informations', font=('arial', 15, 'bold'))
        College_Frame_1.pack(side=LEFT, padx=10)

        College_Frame_2 = LabelFrame(College_Data_Frame, width=495, height=350, bg='green', relief='ridge', bd=8,
