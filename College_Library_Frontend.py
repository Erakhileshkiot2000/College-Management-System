    ...
    def __init__(self, root):
        ...
        def Insert():
            if(len(self.referenceno.get()) != 0):
                College_Library_Backend.insert(self.Mbtype.get(), self.referenceno.get(), self.firstname.get(), self.lastname.get(), self.address.get(
                ), self.post.get(), self.mobileno.get(), self.ID.get(), self.title.get(), self.author.get(), self.borrow.get(), self.due.get(), self.loan.get())
                self.List_bx_2.delete(0, END)
                self.List_bx_2.insert(END, (self.Mbtype.get(), self.referenceno.get(), self.firstname.get(), self.lastname.get(), self.address.get(
                ), self.post.get(), self.mobileno.get(), self.ID.get(), self.title.get(), self.author.get(), self.borrow.get(), self.due.get(), self.loan.get()))
        ...
        def Exit():
            Exit = tkinter.messagebox.askyesno(
                'Library Management System', 'Confirm if you want to Exit')
            if Exit > 0:
                root.destroy()
                return
        ...
        def Search():
            self.List_bx_2.delete(0, END)
            for row in College_Library_Backend.search(self.Mbtype.get(), self.referenceno.get(), self.firstname.get(), self.lastname.get(), self.address.get(), self.post.get(), self.mobileno.get(), self.ID.get(), self.title.get(), self.author.get(), self.borrow.get(), self.due.get(), self.loan.get()):
                self.List_bx_2.insert(END, row, str(' '))

        def Details():
            self.Display_Layout.delete('1.0', END)
            self.Display_Layout.insert(END, 'Book ID: ' + self.ID.get() + '\n')
            self.Display_Layout.insert(
                END, 'Title: ' + self.title.get() + '\n')
            self.Display_Layout.insert(
                END, 'Author:  ' + self.author.get() + '\n')
            self.Display_Layout.insert(
                END, 'Edition: ' + self.editions.get() + '\n')
            self.Display_Layout.insert(
                END, 'Year of Published: \t' + self.yr_of_pub.get() + '\n')
            self.Display_Layout.insert(
                END, 'Date Borrowed: ' + self.borrow.get() + '\n')
            self.Display_Layout.insert(
                END, 'Date Due:' + self.due.get() + '\n')
            self.Display_Layout.insert(
                END, 'Days in Loan: ' + self.loan.get() + '\n')

        Library_Main_Frame = Frame(self.root, bg='Green')
        Library_Main_Frame.grid()

        Library_Title_Frame_1 = Frame(
            Library_Main_Frame, width=1350, bg='Green', relief=RIDGE, bd=15, padx=20)
        ...
        btn_Frame = Frame(Library_Main_Frame, width=1350,
                          height=50, relief=RIDGE, bd=10, bg='Green')
        btn_Frame.pack(side=BOTTOM)

        Library_Detail_Frame = Frame(
            Library_Main_Frame, width=1350, height=100, relief=RIDGE, bd=10, bg='Green')
        Library_Detail_Frame.pack(side=BOTTOM)

        Library_Data_Frame = Frame(
            Library_Main_Frame, width=1350, height=400, relief=RIDGE, bd=15, bg='Green')
        Library_Data_Frame.pack(side=BOTTOM)

        Library_Frame_1 = LabelFrame(Library_Data_Frame, width=800, height=400, relief=RIDGE, bd=10, bg='Green',
                                     text="Library Membership Info:", padx=20, font=('arial', 15, 'bold'))
        Library_Frame_1.pack(side=LEFT, padx=3)

        Library_Frame_2 = LabelFrame(Library_Data_Frame, width=550, height=400, relief=RIDGE, bd=10, bg='Green',
        ...
        self.List_bx_1 = Listbox(Library_Frame_2, font=(
            'arial', 13, 'bold'), width=20, height=10)
        ...
        self.List_bx_2 = Listbox(Library_Detail_Frame, font=(
            'arial', 13, 'bold'), width=144, height=11)
        ...
        btnsave_1 = Button(btn_Frame, text='SAVE', font=(
        ...
        btnexit_7 = Button(btn_Frame, text='EXIT', font=(
